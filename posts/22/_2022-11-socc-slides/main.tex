...
\begin{document}
    ...
    \begin{frame}
        ...
        have become so large that \textbf{distributed training is necessary}.

        \vskip 1em
        Communication overhead is a major problem in distributed DNN training. Using \textbf{TPUs} with fast device-to-device
        links, communication takes up to \textbf{11\%} of training time. On \textbf{GPU clouds} with Ethernet connection,
